...
const ProjectsPage = () => {
  return (
    <div className="w-full h-full min-h-screen flex flex-col bg-white">
      <TopNavigation />
      <div className="flex flex-col mt-32 px-8 mr-8 mb-24 md:mt-32 md:px-16 md:mx-auto xl:px-24 xl:max-w-[1280px]">
        <section className="max-w-6xl mx-auto w-full mb-24 md:mb-20">
          ...
          <div className="block mt-4 p-1 max-w-[600px] text-justify font-medium text-textBlack font-raleway">
            ...
            since I'm always working on something new, so let me know if you're
            interested!
          </div>

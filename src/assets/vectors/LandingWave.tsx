...
const LandingWave = (props: Props) => (
  ...
  >
    <path
      ...
      stroke="#8ECAE6"
      css={tw`animate-pulse [animation-duration: 3s] [animation-delay: 1s]`}
    />
    <path

...
const AboutMeDecor = ({ circleColor, ...props }: Props) => (
  ...
  >
    <circle cx="73.5" cy="31.5" r="31.5" fill="#8ECAE6" fill-opacity="0.1" />
    <circle cx="99.5" cy="118.5" r="31.5" fill="#8ECAE6" fill-opacity="0.1" />
    <circle cx="24" cy="87" r="24" fill="#8ECAE6" />
    <ellipse
      cx="28.5"
      cy="152"
      rx="19.5"

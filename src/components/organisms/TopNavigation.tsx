...
const TopNavigation = ({ mode }: Props) => {
  return (
    <nav className="w-full h-auto">
      <div
        className={`flex flex-row justify-between items-center px-10 md:px-24 xl:px-40 py-4 z-50 text-accent border-0 border-b border-b-white bg-white bg-opacity-20 rounded-bl-3xl backdrop-blur-md ${

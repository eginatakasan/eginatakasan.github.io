...
const FrostedBg = styled.div(({ scrollYPos }: Props) => [
  tw`absolute inset-0 border-b border-b-frosted bg-frosted backdrop-blur-lg z-0 transition-opacity opacity-100`,
  scrollYPos < window.innerHeight && tw`opacity-0`,
]);

...
const Container = styled.div(() => [
  tw`flex flex-col px-10 pt-10 pb-5 justify-around md:(flex-row py-5 px-16) xl:(mx-auto px-24 max-w-[1280px]) w-full relative`,
]);
const Line = tw.div`absolute inset-x-16 xl:(inset-x-24) top-0 border-t border-solid border-t-lightGray opacity-60`;

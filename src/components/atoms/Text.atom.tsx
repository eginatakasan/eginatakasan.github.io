...
const Title = tw.h1`[font-size: 42px] md:([font-size: 52px] [line-height: 1.4]) text-accent m-0 font-extrabold`;
const HeadingOne = tw.h1`[font-size: 32px] md:([font-size: 40px] [line-height: 1.2]) text-accent m-0 font-extrabold`;
